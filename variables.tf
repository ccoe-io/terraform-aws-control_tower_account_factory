...
variable "vcs_provider" {
  ...
  default     = "codecommit"
  validation {
    condition     = contains(["codecommit", "bitbucket", "gitlab", "github", "githubenterprise"], var.vcs_provider)
    error_message = "Valid values for var: vcs_provider are (codecommit, bitbucket, gitlab, github, githubenterprise)."
  }
}
